...
CS.SEASONS = [{
  ...
  sentencePlaceholder: 'ex) 오늘 읽은 부분에서 가장 마음에 남은 문장을 그대로 옮겨 적고, '
    + '끝에 쪽수를 붙여 주세요. (예: … - 47쪽)',
  otLink: {
  ...
  readingPlan: [
    ...
    [{ ch: '1장', s: ['《번외편》 ‘탈노동집약형’과 ‘탈완판사고’'] }],
    [{ ch: '', s: ['🔴 <strong>라이브 1회차</strong> — 새로 읽을 분량은 없습니다. 이번 주 <strong>발제문</strong>에 대해 고민해 보세요.'] }],
    // 2주차 — 2장 커뮤니티
    ...
    [{ ch: '', s: ['🔴 <strong>라이브 2회차</strong> — 새로 읽을 분량은 없습니다. 이번 주 <strong>발제문</strong>에 대해 고민해 보세요.'] }],
    // 3주차 — 3장 NFT + 맺음말
    [{ ch: '3장', s: ['바다에 잠겨 있는 돈 이야기', '새로운 문 앞에는 언제나 긴 설명이 있다'] }],
    [{ ch: '3장', s: ['NFT를 엄청 간단하게 설명하겠다', '그림책 작가의 새로운 수입원'] }],
    [{ ch: '3장', s: ['NFT라는 럭셔리 상품', '돈 같은 ‘공동 환상’'] }],
    [{ ch: '3장', s: ['‘디지털 폭탄 돌리기’가 된 NFT', 'AI × NFT로 활동 자금을 만든다'] }],
    [{ ch: '3장', s: ['사람을 돕는 돈을 모으는 도구'] }],
    [
      { ch: '3장', s: ['시대를 바르게 파악하라'] },
      { ch: '맺음말', s: ['~꿈과 돈~ — 📕 <strong>완독일!</strong>'] }
    ],
    [{ ch: '', s: ['🔴 <strong>라이브 3회차</strong> — 새로 읽을 분량은 없습니다. 이번 주 <strong>발제문</strong>에 대해 고민해 보세요.'] }],
    // 4주차 — 재독 주간 (밑줄 친 부분만). 마지막 날은 라이브로 마무리한다.
    [{ ch: '', s: ['재독 주간입니다. 새로 읽지 않고, 1~3주차에 <strong>밑줄 친 부분만</strong> 다시 읽습니다.'] }],
    [{ ch: '', s: ['재독 주간입니다. 새로 읽지 않고, 1~3주차에 <strong>밑줄 친 부분만</strong> 다시 읽습니다.'] }],
    [{ ch: '', s: ['재독 주간입니다. 새로 읽지 않고, 1~3주차에 <strong>밑줄 친 부분만</strong> 다시 읽습니다.'] }],
    [{ ch: '', s: ['재독 주간입니다. 새로 읽지 않고, 1~3주차에 <strong>밑줄 친 부분만</strong> 다시 읽습니다.'] }],
    [{ ch: '', s: ['재독 주간입니다. 새로 읽지 않고, 1~3주차에 <strong>밑줄 친 부분만</strong> 다시 읽습니다.'] }],
    [{ ch: '', s: ['재독 주간입니다. 새로 읽지 않고, 1~3주차에 <strong>밑줄 친 부분만</strong> 다시 읽습니다.'] }],
    [{ ch: '', s: ['🔴 <strong>라이브 4회차</strong> — 마지막 시간입니다. 새로 읽을 분량은 없습니다. 이번 주 <strong>발제문</strong>에 대해 고민해 보세요.'] }]
  ]
}];
