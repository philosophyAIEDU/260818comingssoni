...
CS.SEASONS = [{
  ...
  // 종료 다음 날부터 이 날까지는 회고 세션 — 앱이 안내를 띄운다(인증은 닫힌 채로). 다음 시즌은 10/21.
  retroUntil: '2026-10-20',
  ...
  // 📝 주간 발제문 — 라이브 날(일요일) 오전에 단톡방에 올리는 질문. 그날 앱 [오늘의 범위]에도
  // 같이 보이고, 운영진 [공지문 › 발제문]에서 복사할 수 있다. day는 1일차부터 센 회차 번호.
  // 아래는 목차로 뽑은 초안이다 — 라이브 전 주에 커밍쏜이 다듬어 쓴다.
  weeklyPrompts: [
    { day: 7, questions: [
      '니시노는 "기능을 파니까 싸다고 느끼는 거다"라고 합니다. 지금 내 상품·콘텐츠는 기능을 팔고 있나요, 아니면 다른 무언가를 팔고 있나요? 솔직하게 한 줄로 적어 보세요.',
      '\'프리미엄\'과 \'럭셔리\'의 차이를 내 말로 다시 설명해 보고, 내 브랜드는 어느 쪽에 서고 싶은지 정해 보세요.',
      '"당신의 도전에 큰돈을 내는 사람"은 누구일까요? 실제로 있는 한 사람을 떠올려, 그 사람의 하루를 세 줄로 적어 보세요.'
    ] },
    { day: 14, questions: [
      '사람들이 나를 \'기능 검색\'이 아니라 \'사람 검색\'으로 찾아오게 하려면, 내가 지금보다 더 드러내야 할 것은 무엇일까요?',
      '\'응원할 여지\'의 계산식을 내 브랜드에 대입해 보세요. 지금 사람들이 나를 응원할 여지가 있나요? 없다면 무엇을 덜어내거나 무엇을 보여줘야 할까요?',
      '2장에서 읽은 것 중 이번 주 안에 바로 실행할 것 한 가지. 언제, 어디에 올릴지까지 적어 주세요.'
    ] },
    { day: 21, questions: [
      '1회독을 마쳤습니다. 내 밑줄 BEST 10 중 단 하나만 남긴다면 어떤 문장이고, 왜 그 문장인가요?',
      '돈은 \'공동 환상\'이라는 말을 내 비즈니스로 가져오면, 내 팬과 내가 함께 믿고 있는 환상(가치)은 무엇인가요? 아직 없다면 무엇이어야 할까요?',
      '\'시대를 바르게 파악하라\'를 내 분야에 적용하면, 지금 내가 놓치고 있는 흐름은 무엇인가요?'
    ] },
    { day: 28, questions: [
      '28일 중 나의 최고 문장 1개와, 그 문장이 내 브랜드에서 어떻게 실행되었는지(또는 될지) 한 문단으로 적어 주세요.',
      '이 책을 읽기 전과 후, \'돈\'에 대한 내 정의가 어떻게 바뀌었나요?',
      '다음 한 달, 이 책에서 가져가 계속할 습관 하나를 선언해 주세요.'
    ] }
  ],
